...
/* The defaults.h file serves as a central default settings selector for different machine
  ...
  #define DEFAULT_X_MAX_TRAVEL 275.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_Y_MAX_TRAVEL 397.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_Z_MAX_TRAVEL 0.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_SPINDLE_RPM_MAX 400.0 // rpm
